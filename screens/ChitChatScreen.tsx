...
type ChitChatScreenNavigationProp = NativeStackNavigationProp<
  RootStackParamList,
  "ChitChat"
>;

export default function ChitChatScreen() {
  const navigation = useNavigation<ChitChatScreenNavigationProp>();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Chit-Chat</Text>
